...
public class TurretSubsystem {
    ...
    public TurretSubsystem(HardwareMap hardwareMap, String turretMotorName, String turretAngleServoName,
            Telemetry telemetry, FlywheelSubsystem flywheel) {
        ...
        // Soft-zero at init: turret angle will be 0 at whatever position you are in
        // during init.
        zeroTurretHere();
    ...
    /**
     * Adjust hood/angle servo by joystick -1..1 mapped to 0..1. Holds position in
     * deadband.
     */
    ...
    private void doKinematics(double distance) {
        ...
        // flywheel Angular Velocity =((ball speed(m/s)/efficiency)/wheel
        // circumfrence(m))
