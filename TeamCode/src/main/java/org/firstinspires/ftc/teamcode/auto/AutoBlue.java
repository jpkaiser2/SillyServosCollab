...
public class AutoBlue extends OpMode {
    ...
    public void loop() {
        ...
        // Step 4: Move 2 feet to the left after launch completes
        if (launchComplete && !lateralMoveStarted) {
            Pose currentPose = follower.getPose();
            // Move 2 feet (24 inches) to the left (positive Y direction)
            ...
            telemetry.addData("Status", "Moving left 2 feet");
        }
